...
<script>
    $(function () {
        ...
        var areaChartDataGlycemic = {
            labels: [{foreach from=$exams item=e}"{$e.date}", {/foreach}],
            datasets: [
                {
                    label: "Electronics",
                    ...
                    data: [{foreach from=$exams item=e}{$e.examValue}, {/foreach}]
                }
            ]
        };
        ...
        var areaChartDataWelfare = {
            labels: [{foreach from=$feels item=e}"{$e.date}", {/foreach}],
            datasets: [
                {
                    label: "Electronics",
                    fillColor: "rgba(210, 214, 222, 1)",
                    ...
                    pointHighlightFill: "#fff",
                    pointHighlightStroke: "rgba(220,220,220,1)",
                    data: [{foreach from=$feels item=e}{$e.feel}, {/foreach}]
                }
            ]
        };
